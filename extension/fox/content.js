...
let security_theater_inject = function(url,opts)
{
	...
	return security_theater.new_fetch(url,opts) // first call
}
exportFunction(security_theater_inject, window, { defineAs: "fetch" });
